...
const EXPERIENCE_DETAILS = (props) => {
  ...
  const EDIT = (e) => {
    ...
    document.querySelector("#edit-position").children[1].value =
      e.target.parentElement.children[1].textContent;
    document.querySelector("#edit-company").children[1].value =
      e.target.parentElement.children[2].children[0].textContent.slice(9);
    document.querySelector("#edit-city").children[1].value =
      e.target.parentElement.children[2].children[1].textContent.slice(6);
    document.querySelector("#edit-experience-start-date").children[1].value =
      e.target.parentElement.children[0].children[0].textContent.slice(0, -3);
    document.querySelector("#edit-experience-end-date").children[1].value =
      e.target.parentElement.children[0].children[1].textContent;
    document
      .querySelector("#experience-square")
